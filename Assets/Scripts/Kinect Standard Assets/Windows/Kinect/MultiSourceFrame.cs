...
namespace Windows.Kinect
{
    ...
    public sealed partial class MultiSourceFrame : Helper.INativeWrapper
    {
        ...
        private static extern void Windows_Kinect_MultiSourceFrame_ReleaseObject(
        ...
        private static extern void Windows_Kinect_MultiSourceFrame_AddRefObject(
            ref RootSystem.IntPtr pNative
        );
        ...
        public Windows.Kinect.BodyFrameReference BodyFrameReference
        {
            get
            {
                ...
                RootSystem.IntPtr objectPointer =
                    Windows_Kinect_MultiSourceFrame_get_BodyFrameReference(_pNative);
                ...
                return Helper.NativeObjectCache.CreateOrGetObject<Windows.Kinect.BodyFrameReference>(
                    objectPointer,
                    n => new Windows.Kinect.BodyFrameReference(n)
                );
            }
        }
        ...
        public Windows.Kinect.BodyIndexFrameReference BodyIndexFrameReference
        {
            get
            {
                ...
                RootSystem.IntPtr objectPointer =
                    Windows_Kinect_MultiSourceFrame_get_BodyIndexFrameReference(_pNative);
                Helper.ExceptionHelper.CheckLastError();
                if (objectPointer == RootSystem.IntPtr.Zero)
                {
                    return null;
                ...
                return Helper.NativeObjectCache.CreateOrGetObject<Windows.Kinect.BodyIndexFrameReference>(
                    objectPointer,
                    n => new Windows.Kinect.BodyIndexFrameReference(n)
                );
            }
        }
        ...
        public Windows.Kinect.ColorFrameReference ColorFrameReference
        {
            get
            {
                ...
                RootSystem.IntPtr objectPointer =
                    Windows_Kinect_MultiSourceFrame_get_ColorFrameReference(_pNative);
                Helper.ExceptionHelper.CheckLastError();
                if (objectPointer == RootSystem.IntPtr.Zero)
                {
                    return null;
                ...
                return Helper.NativeObjectCache.CreateOrGetObject<Windows.Kinect.ColorFrameReference>(
                    objectPointer,
                    n => new Windows.Kinect.ColorFrameReference(n)
                );
            }
        }
        ...
        public Windows.Kinect.DepthFrameReference DepthFrameReference
        {
            get
            {
                ...
                RootSystem.IntPtr objectPointer =
                    Windows_Kinect_MultiSourceFrame_get_DepthFrameReference(_pNative);
                Helper.ExceptionHelper.CheckLastError();
                if (objectPointer == RootSystem.IntPtr.Zero)
                {
                    return null;
                ...
                return Helper.NativeObjectCache.CreateOrGetObject<Windows.Kinect.DepthFrameReference>(
                    objectPointer,
                    n => new Windows.Kinect.DepthFrameReference(n)
                );
            }
        }
        ...
        public Windows.Kinect.InfraredFrameReference InfraredFrameReference
        {
            get
            {
                ...
                RootSystem.IntPtr objectPointer =
                    Windows_Kinect_MultiSourceFrame_get_InfraredFrameReference(_pNative);
                Helper.ExceptionHelper.CheckLastError();
                if (objectPointer == RootSystem.IntPtr.Zero)
                {
                    return null;
                ...
                return Helper.NativeObjectCache.CreateOrGetObject<Windows.Kinect.InfraredFrameReference>(
                    objectPointer,
                    n => new Windows.Kinect.InfraredFrameReference(n)
                );
            }
        }
        ...
        public Windows.Kinect.LongExposureInfraredFrameReference LongExposureInfraredFrameReference
        {
            get
            {
                ...
                RootSystem.IntPtr objectPointer =
                    Windows_Kinect_MultiSourceFrame_get_LongExposureInfraredFrameReference(
                        _pNative
                    );
                Helper.ExceptionHelper.CheckLastError();
                if (objectPointer == RootSystem.IntPtr.Zero)
                ...
                return Helper.NativeObjectCache.CreateOrGetObject<Windows.Kinect.LongExposureInfraredFrameReference>(
                    objectPointer,
                    n => new Windows.Kinect.LongExposureInfraredFrameReference(n)
                );
            }
        }
