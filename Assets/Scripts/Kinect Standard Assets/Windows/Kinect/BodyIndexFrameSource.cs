...
namespace Windows.Kinect
{
    ...
    public sealed partial class BodyIndexFrameSource : Helper.INativeWrapper
    {
        ...
        private static extern void Windows_Kinect_BodyIndexFrameSource_ReleaseObject(
        ...
        private static extern void Windows_Kinect_BodyIndexFrameSource_AddRefObject(
            ref RootSystem.IntPtr pNative
        );
        ...
        public Windows.Kinect.FrameDescription FrameDescription
        {
            get
            {
                ...
                RootSystem.IntPtr objectPointer =
                    Windows_Kinect_BodyIndexFrameSource_get_FrameDescription(_pNative);
        ...
        private static extern bool Windows_Kinect_BodyIndexFrameSource_get_IsActive(
            RootSystem.IntPtr pNative
        );
        ...
        public Windows.Kinect.KinectSensor KinectSensor
        {
            get
            {
                ...
                RootSystem.IntPtr objectPointer =
                    Windows_Kinect_BodyIndexFrameSource_get_KinectSensor(_pNative);
                Helper.ExceptionHelper.CheckLastError();
                if (objectPointer == RootSystem.IntPtr.Zero)
                {
                    return null;
        ...
        private static extern void Windows_Kinect_BodyIndexFrameSource_add_FrameCaptured(
            RootSystem.IntPtr pNative,
        ...
        public event RootSystem.EventHandler<Windows.Kinect.FrameCapturedEventArgs> FrameCaptured
        {
            ...
            remove
            {
                ...
                lock (callbackList)
                {
                    ...
                    {
                        Windows_Kinect_BodyIndexFrameSource_add_FrameCaptured(
                            _pNative,
                            Windows_Kinect_FrameCapturedEventArgs_Delegate_Handler,
                            true
                        );
        ...
        private static extern void Windows_Kinect_BodyIndexFrameSource_add_PropertyChanged(
            RootSystem.IntPtr pNative,
                ...
                lock (callbackList)
                {
                    ...
                    if (callbackList.Count == 1)
                    {
                        ...
                        _Windows_Data_PropertyChangedEventArgs_Delegate_Handle =
                            RootSystem.Runtime.InteropServices.GCHandle.Alloc(del);
                        Windows_Kinect_BodyIndexFrameSource_add_PropertyChanged(
                            _pNative,
                            del,
                            false
                        );
        ...
        public Windows.Kinect.BodyIndexFrameReader OpenReader()
        {
            ...
            RootSystem.IntPtr objectPointer = Windows_Kinect_BodyIndexFrameSource_OpenReader(
                _pNative
            );
            Helper.ExceptionHelper.CheckLastError();
            if (objectPointer == RootSystem.IntPtr.Zero)
            ...
            return Helper.NativeObjectCache.CreateOrGetObject<Windows.Kinect.BodyIndexFrameReader>(
                objectPointer,
                n => new Windows.Kinect.BodyIndexFrameReader(n)
            );
        }
