...
namespace Windows.Kinect
{
    ...
    public sealed partial class InfraredFrameReader : RootSystem.IDisposable, Helper.INativeWrapper
    {
        ...
        private static extern void Windows_Kinect_InfraredFrameReader_ReleaseObject(
        ...
        private static extern void Windows_Kinect_InfraredFrameReader_AddRefObject(
            ref RootSystem.IntPtr pNative
        );
        ...
        public Windows.Kinect.InfraredFrameSource InfraredFrameSource
        {
            get
            {
                ...
                RootSystem.IntPtr objectPointer =
                    Windows_Kinect_InfraredFrameReader_get_InfraredFrameSource(_pNative);
        ...
        private static extern bool Windows_Kinect_InfraredFrameReader_get_IsPaused(
            RootSystem.IntPtr pNative
        );
        ...
        private static extern void Windows_Kinect_InfraredFrameReader_put_IsPaused(
            RootSystem.IntPtr pNative,
            bool isPaused
        );
        ...
        private static Helper.CollectionMap<
            RootSystem.IntPtr,
            List<RootSystem.EventHandler<Windows.Kinect.InfraredFrameArrivedEventArgs>>
        ...
        [AOT.MonoPInvokeCallbackAttribute(
            typeof(_Windows_Kinect_InfraredFrameArrivedEventArgs_Delegate)
        )]
        private static void Windows_Kinect_InfraredFrameArrivedEventArgs_Delegate_Handler(
            RootSystem.IntPtr result,
            RootSystem.IntPtr pNative
        )
        {
            List<RootSystem.EventHandler<Windows.Kinect.InfraredFrameArrivedEventArgs>> callbackList =
                null;
            Windows_Kinect_InfraredFrameArrivedEventArgs_Delegate_callbacks.TryGetValue(
                pNative,
                out callbackList
            );
            lock (callbackList)
        ...
        private static extern void Windows_Kinect_InfraredFrameReader_add_FrameArrived(
            RootSystem.IntPtr pNative,
            _Windows_Kinect_InfraredFrameArrivedEventArgs_Delegate eventCallback,
            bool unsubscribe
        );
        ...
        public event RootSystem.EventHandler<Windows.Kinect.InfraredFrameArrivedEventArgs> FrameArrived
        {
            add
            {
                ...
                Windows_Kinect_InfraredFrameArrivedEventArgs_Delegate_callbacks.TryAddDefault(
                    _pNative
                );
                var callbackList = Windows_Kinect_InfraredFrameArrivedEventArgs_Delegate_callbacks[
                    _pNative
                ];
                lock (callbackList)
                {
            ...
            remove
            {
                ...
                lock (callbackList)
                {
                    ...
                    {
                        Windows_Kinect_InfraredFrameReader_add_FrameArrived(
                            _pNative,
                            Windows_Kinect_InfraredFrameArrivedEventArgs_Delegate_Handler,
                            true
                        );
        ...
        private static extern void Windows_Kinect_InfraredFrameReader_add_PropertyChanged(
            RootSystem.IntPtr pNative,
                ...
                lock (callbackList)
                {
                    ...
                    if (callbackList.Count == 1)
                    {
                        ...
                        _Windows_Data_PropertyChangedEventArgs_Delegate_Handle =
                            RootSystem.Runtime.InteropServices.GCHandle.Alloc(del);
                        Windows_Kinect_InfraredFrameReader_add_PropertyChanged(
                            _pNative,
                            del,
                            false
                        );
        ...
        public Windows.Kinect.InfraredFrame AcquireLatestFrame()
        {
            ...
            RootSystem.IntPtr objectPointer = Windows_Kinect_InfraredFrameReader_AcquireLatestFrame(
                _pNative
            );
            Helper.ExceptionHelper.CheckLastError();
            if (objectPointer == RootSystem.IntPtr.Zero)
            ...
            return Helper.NativeObjectCache.CreateOrGetObject<Windows.Kinect.InfraredFrame>(
                objectPointer,
                n => new Windows.Kinect.InfraredFrame(n)
            );
        }
        ...
        private static extern void Windows_Kinect_InfraredFrameReader_Dispose(
            RootSystem.IntPtr pNative
        );
