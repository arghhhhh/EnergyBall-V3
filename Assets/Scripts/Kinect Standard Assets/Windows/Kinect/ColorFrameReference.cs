...
namespace Windows.Kinect
{
    ...
    public sealed partial class ColorFrameReference : Helper.INativeWrapper
    {
        ...
        private static extern void Windows_Kinect_ColorFrameReference_ReleaseObject(
        ...
        private static extern void Windows_Kinect_ColorFrameReference_AddRefObject(
            ref RootSystem.IntPtr pNative
        );
        ...
        private static extern long Windows_Kinect_ColorFrameReference_get_RelativeTime(
        ...
        public Windows.Kinect.ColorFrame AcquireFrame()
        {
            ...
            RootSystem.IntPtr objectPointer = Windows_Kinect_ColorFrameReference_AcquireFrame(
                _pNative
            );
