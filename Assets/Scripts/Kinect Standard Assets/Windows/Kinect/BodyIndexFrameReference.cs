...
namespace Windows.Kinect
{
    ...
    public sealed partial class BodyIndexFrameReference : Helper.INativeWrapper
    {
        ...
        private static extern void Windows_Kinect_BodyIndexFrameReference_ReleaseObject(
        ...
        private static extern void Windows_Kinect_BodyIndexFrameReference_AddRefObject(
            ref RootSystem.IntPtr pNative
        );
        ...
        private static extern long Windows_Kinect_BodyIndexFrameReference_get_RelativeTime(
        ...
        public Windows.Kinect.BodyIndexFrame AcquireFrame()
        {
            ...
            RootSystem.IntPtr objectPointer = Windows_Kinect_BodyIndexFrameReference_AcquireFrame(
                _pNative
            );
