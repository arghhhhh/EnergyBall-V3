...
namespace Windows.Kinect
{
    ...
    public sealed partial class ColorFrameReader : RootSystem.IDisposable, Helper.INativeWrapper
    {
        ...
        private static extern void Windows_Kinect_ColorFrameReader_ReleaseObject(
        ...
        private static extern void Windows_Kinect_ColorFrameReader_AddRefObject(
            ref RootSystem.IntPtr pNative
        );
        ...
        public Windows.Kinect.ColorFrameSource ColorFrameSource
        {
            get
            {
                ...
                RootSystem.IntPtr objectPointer =
                    Windows_Kinect_ColorFrameReader_get_ColorFrameSource(_pNative);
        ...
        private static extern bool Windows_Kinect_ColorFrameReader_get_IsPaused(
            RootSystem.IntPtr pNative
        );
        ...
        private static extern void Windows_Kinect_ColorFrameReader_put_IsPaused(
            RootSystem.IntPtr pNative,
            bool isPaused
        );
        ...
        private static Helper.CollectionMap<
            RootSystem.IntPtr,
            List<RootSystem.EventHandler<Windows.Kinect.ColorFrameArrivedEventArgs>>
        > Windows_Kinect_ColorFrameArrivedEventArgs_Delegate_callbacks = new Helper.CollectionMap<
            RootSystem.IntPtr,
            List<RootSystem.EventHandler<Windows.Kinect.ColorFrameArrivedEventArgs>>
        >();

        [AOT.MonoPInvokeCallbackAttribute(
            typeof(_Windows_Kinect_ColorFrameArrivedEventArgs_Delegate)
        )]
        private static void Windows_Kinect_ColorFrameArrivedEventArgs_Delegate_Handler(
            RootSystem.IntPtr result,
            RootSystem.IntPtr pNative
        )
        {
            List<RootSystem.EventHandler<Windows.Kinect.ColorFrameArrivedEventArgs>> callbackList =
                null;
            Windows_Kinect_ColorFrameArrivedEventArgs_Delegate_callbacks.TryGetValue(
                pNative,
                out callbackList
            );
            lock (callbackList)
        ...
        private static extern void Windows_Kinect_ColorFrameReader_add_FrameArrived(
            RootSystem.IntPtr pNative,
            _Windows_Kinect_ColorFrameArrivedEventArgs_Delegate eventCallback,
            bool unsubscribe
        );
        ...
        public event RootSystem.EventHandler<Windows.Kinect.ColorFrameArrivedEventArgs> FrameArrived
        {
            add
            {
                ...
                Windows_Kinect_ColorFrameArrivedEventArgs_Delegate_callbacks.TryAddDefault(
                    _pNative
                );
                var callbackList = Windows_Kinect_ColorFrameArrivedEventArgs_Delegate_callbacks[
                    _pNative
                ];
                lock (callbackList)
                {
            ...
            remove
            {
                ...
                lock (callbackList)
                {
                    ...
                    {
                        Windows_Kinect_ColorFrameReader_add_FrameArrived(
                            _pNative,
                            Windows_Kinect_ColorFrameArrivedEventArgs_Delegate_Handler,
                            true
                        );
        ...
        private static extern void Windows_Kinect_ColorFrameReader_add_PropertyChanged(
            RootSystem.IntPtr pNative,
        ...
        public event RootSystem.EventHandler<Windows.Data.PropertyChangedEventArgs> PropertyChanged
        {
            ...
            remove
            {
                ...
                lock (callbackList)
                {
                    ...
                    if (callbackList.Count == 0)
                    {
                        Windows_Kinect_ColorFrameReader_add_PropertyChanged(
                            _pNative,
                            Windows_Data_PropertyChangedEventArgs_Delegate_Handler,
                            true
                        );
        ...
        public Windows.Kinect.ColorFrame AcquireLatestFrame()
        {
            ...
            RootSystem.IntPtr objectPointer = Windows_Kinect_ColorFrameReader_AcquireLatestFrame(
                _pNative
            );
            Helper.ExceptionHelper.CheckLastError();
            if (objectPointer == RootSystem.IntPtr.Zero)
            ...
            return Helper.NativeObjectCache.CreateOrGetObject<Windows.Kinect.ColorFrame>(
                objectPointer,
                n => new Windows.Kinect.ColorFrame(n)
            );
        }
        ...
        private static extern void Windows_Kinect_ColorFrameReader_Dispose(
            RootSystem.IntPtr pNative
        );
