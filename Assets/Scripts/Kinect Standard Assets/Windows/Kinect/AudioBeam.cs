...
namespace Windows.Kinect
{
    ...
    public sealed partial class AudioBeam : Helper.INativeWrapper
    {
        ...
        private static extern void Windows_Kinect_AudioBeam_ReleaseObject(
        ...
        private static extern void Windows_Kinect_AudioBeam_AddRefObject(
            ref RootSystem.IntPtr pNative
        );
        ...
        private static extern Windows.Kinect.AudioBeamMode Windows_Kinect_AudioBeam_get_AudioBeamMode(
        ...
        private static extern void Windows_Kinect_AudioBeam_put_AudioBeamMode(
            RootSystem.IntPtr pNative,
            Windows.Kinect.AudioBeamMode audioBeamMode
        );
        ...
        private static extern RootSystem.IntPtr Windows_Kinect_AudioBeam_get_AudioSource(
            RootSystem.IntPtr pNative
        );
        ...
        public Windows.Kinect.AudioSource AudioSource
        {
            get
            {
                ...
                RootSystem.IntPtr objectPointer = Windows_Kinect_AudioBeam_get_AudioSource(
                    _pNative
                );
                Helper.ExceptionHelper.CheckLastError();
        ...
        private static extern float Windows_Kinect_AudioBeam_get_BeamAngle(
            RootSystem.IntPtr pNative
        );
        ...
        private static extern void Windows_Kinect_AudioBeam_put_BeamAngle(
            RootSystem.IntPtr pNative,
            float beamAngle
        );
        ...
        private static extern float Windows_Kinect_AudioBeam_get_BeamAngleConfidence(
            RootSystem.IntPtr pNative
        );
        ...
        private static extern long Windows_Kinect_AudioBeam_get_RelativeTime(
            RootSystem.IntPtr pNative
        );
        ...
        public RootSystem.TimeSpan RelativeTime
        {
            get
            {
                ...
                return RootSystem.TimeSpan.FromMilliseconds(
                    Windows_Kinect_AudioBeam_get_RelativeTime(_pNative)
                );
            }
        }
        ...
        private static extern void Windows_Kinect_AudioBeam_add_PropertyChanged(
            RootSystem.IntPtr pNative,
        ...
        public event RootSystem.EventHandler<Windows.Data.PropertyChangedEventArgs> PropertyChanged
        {
            ...
            remove
            {
                ...
                lock (callbackList)
                {
                    ...
                    {
                        Windows_Kinect_AudioBeam_add_PropertyChanged(
                            _pNative,
                            Windows_Data_PropertyChangedEventArgs_Delegate_Handler,
                            true
                        );
