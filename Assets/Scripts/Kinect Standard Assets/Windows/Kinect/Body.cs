...
namespace Windows.Kinect
{
    ...
    public sealed partial class Body : Helper.INativeWrapper
    {
        ...
        private static extern int Windows_Kinect_Body_get_Activities(
            RootSystem.IntPtr pNative,
            [RootSystem.Runtime.InteropServices.Out] Windows.Kinect.Activity[] outKeys,
            [RootSystem.Runtime.InteropServices.Out] Windows.Kinect.DetectionResult[] outValues,
        ...
        private static extern int Windows_Kinect_Body_get_Activities_Length(
            RootSystem.IntPtr pNative
        );

        public RootSystem.Collections.Generic.Dictionary<
        ...
        > Activities
        {
            get
            {
                ...
                var managedDictionary = new RootSystem.Collections.Generic.Dictionary<
                    Windows.Kinect.Activity,
                    Windows.Kinect.DetectionResult
                >();

                outCollectionSize = Windows_Kinect_Body_get_Activities(
                    _pNative,
                    outKeys,
                    outValues,
                    outCollectionSize
        ...
        private static extern int Windows_Kinect_Body_get_Appearance(
            RootSystem.IntPtr pNative,
            [RootSystem.Runtime.InteropServices.Out] Windows.Kinect.Appearance[] outKeys,
            [RootSystem.Runtime.InteropServices.Out] Windows.Kinect.DetectionResult[] outValues,
            int outCollectionSize
        );
        ...
        private static extern int Windows_Kinect_Body_get_Appearance_Length(
            RootSystem.IntPtr pNative
        );
        ...
        > Appearance
        {
            get
            {
                ...
                outCollectionSize = Windows_Kinect_Body_get_Appearance(
                    _pNative,
                    outKeys,
                    outValues,
                    outCollectionSize
        ...
        private static extern Windows.Kinect.FrameEdges Windows_Kinect_Body_get_ClippedEdges(
            RootSystem.IntPtr pNative
        );
        ...
        private static extern Windows.Kinect.DetectionResult Windows_Kinect_Body_get_Engaged(
            RootSystem.IntPtr pNative
        );
        ...
        private static extern int Windows_Kinect_Body_get_Expressions(
            RootSystem.IntPtr pNative,
            [RootSystem.Runtime.InteropServices.Out] Windows.Kinect.Expression[] outKeys,
            [RootSystem.Runtime.InteropServices.Out] Windows.Kinect.DetectionResult[] outValues,
            int outCollectionSize
        );
        ...
        private static extern int Windows_Kinect_Body_get_Expressions_Length(
            RootSystem.IntPtr pNative
        );
        ...
        > Expressions
        {
            get
            {
                ...
                outCollectionSize = Windows_Kinect_Body_get_Expressions(
                    _pNative,
                    outKeys,
                    outValues,
                    outCollectionSize
        ...
        private static extern Windows.Kinect.TrackingConfidence Windows_Kinect_Body_get_HandLeftConfidence(
            RootSystem.IntPtr pNative
        );
        ...
        private static extern Windows.Kinect.HandState Windows_Kinect_Body_get_HandLeftState(
            RootSystem.IntPtr pNative
        );
        ...
        private static extern Windows.Kinect.TrackingConfidence Windows_Kinect_Body_get_HandRightConfidence(
            RootSystem.IntPtr pNative
        );
        ...
        private static extern Windows.Kinect.HandState Windows_Kinect_Body_get_HandRightState(
            RootSystem.IntPtr pNative
        );
        ...
        private static extern int Windows_Kinect_Body_get_JointOrientations(
            RootSystem.IntPtr pNative,
            [RootSystem.Runtime.InteropServices.Out] Windows.Kinect.JointType[] outKeys,
            [RootSystem.Runtime.InteropServices.Out] Windows.Kinect.JointOrientation[] outValues,
            int outCollectionSize
        );
        ...
        private static extern int Windows_Kinect_Body_get_JointOrientations_Length(
            RootSystem.IntPtr pNative
        );
        ...
        > JointOrientations
        {
            get
            {
                ...
                outCollectionSize = Windows_Kinect_Body_get_JointOrientations(
                    _pNative,
                    outKeys,
                    outValues,
                    outCollectionSize
        ...
        private static extern int Windows_Kinect_Body_get_Joints(
            RootSystem.IntPtr pNative,
            [RootSystem.Runtime.InteropServices.Out] Windows.Kinect.JointType[] outKeys,
            [RootSystem.Runtime.InteropServices.Out] Windows.Kinect.Joint[] outValues,
            int outCollectionSize
        );
        ...
        > Joints
        {
            get
            {
                ...
                outCollectionSize = Windows_Kinect_Body_get_Joints(
                    _pNative,
                    outKeys,
                    outValues,
                    outCollectionSize
        ...
        private static extern Windows.Kinect.TrackingState Windows_Kinect_Body_get_LeanTrackingState(
            RootSystem.IntPtr pNative
        );
        ...
        {
            get { return Windows_Kinect_Body_get_JointCount(); }
        }
