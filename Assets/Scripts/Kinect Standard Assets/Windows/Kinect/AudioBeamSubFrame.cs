...
namespace Windows.Kinect
{
    ...
    public sealed partial class AudioBeamSubFrame : RootSystem.IDisposable, Helper.INativeWrapper
    {
        ...
        private static extern void Windows_Kinect_AudioBeamSubFrame_ReleaseObject(
        ...
        private static extern void Windows_Kinect_AudioBeamSubFrame_AddRefObject(
            ref RootSystem.IntPtr pNative
        );
        ...
        private static extern Windows.Kinect.AudioBeamMode Windows_Kinect_AudioBeamSubFrame_get_AudioBeamMode(
        ...
        private static extern int Windows_Kinect_AudioBeamSubFrame_get_AudioBodyCorrelations(
            RootSystem.IntPtr pNative,
        ...
        public RootSystem.Collections.Generic.IList<Windows.Kinect.AudioBodyCorrelation> AudioBodyCorrelations
        {
            get
            {
                ...
                int outCollectionSize =
                    Windows_Kinect_AudioBeamSubFrame_get_AudioBodyCorrelations_Length(_pNative);
                ...
                for (int i = 0; i < outCollectionSize; i++)
                {
                    ...
                    var obj =
                        Helper.NativeObjectCache.CreateOrGetObject<Windows.Kinect.AudioBodyCorrelation>(
                            outCollection[i],
                            n => new Windows.Kinect.AudioBodyCorrelation(n)
                        );
        ...
        private static extern float Windows_Kinect_AudioBeamSubFrame_get_BeamAngle(
            RootSystem.IntPtr pNative
        );
        ...
        private static extern float Windows_Kinect_AudioBeamSubFrame_get_BeamAngleConfidence(
            RootSystem.IntPtr pNative
        );
        ...
        private static extern long Windows_Kinect_AudioBeamSubFrame_get_Duration(
            RootSystem.IntPtr pNative
        );
        ...
        public RootSystem.TimeSpan Duration
        {
            get
            {
                ...
                return RootSystem.TimeSpan.FromMilliseconds(
                    Windows_Kinect_AudioBeamSubFrame_get_Duration(_pNative)
                );
            }
        }
        ...
        private static extern uint Windows_Kinect_AudioBeamSubFrame_get_FrameLengthInBytes(
            RootSystem.IntPtr pNative
        );
        ...
        private static extern long Windows_Kinect_AudioBeamSubFrame_get_RelativeTime(
            RootSystem.IntPtr pNative
        );
        ...
        private static extern void Windows_Kinect_AudioBeamSubFrame_CopyFrameDataToArray(
            RootSystem.IntPtr pNative,
        ...
        public void CopyFrameDataToArray(byte[] frameData)
        {
            ...
            Windows_Kinect_AudioBeamSubFrame_CopyFrameDataToArray(
                _pNative,
                _frameData,
                frameData.Length
            );
        ...
        private static extern void Windows_Kinect_AudioBeamSubFrame_Dispose(
            RootSystem.IntPtr pNative
        );
