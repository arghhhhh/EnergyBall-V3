...
namespace Windows.Kinect
{
    ...
    //
    public sealed partial class LongExposureInfraredFrameArrivedEventArgs
            ...
            Helper.INativeWrapper
    {
        ...
        private void Dispose(bool disposing)
        {
            ...
            Helper.NativeObjectCache.RemoveObject<LongExposureInfraredFrameArrivedEventArgs>(
                _pNative
            );
        ...
        private static extern RootSystem.IntPtr Windows_Kinect_LongExposureInfraredFrameArrivedEventArgs_get_FrameReference(
        ...
        public Windows.Kinect.LongExposureInfraredFrameReference FrameReference
        {
            get
            {
                ...
                RootSystem.IntPtr objectPointer =
                    Windows_Kinect_LongExposureInfraredFrameArrivedEventArgs_get_FrameReference(
                        _pNative
                    );
