...
namespace Windows.Kinect
{
    ...
    public sealed partial class ColorFrameSource : Helper.INativeWrapper
    {
        ...
        private static extern void Windows_Kinect_ColorFrameSource_ReleaseObject(
        ...
        private static extern void Windows_Kinect_ColorFrameSource_AddRefObject(
            ref RootSystem.IntPtr pNative
        );
        ...
        public Windows.Kinect.FrameDescription FrameDescription
        {
            get
            {
                ...
                RootSystem.IntPtr objectPointer =
                    Windows_Kinect_ColorFrameSource_get_FrameDescription(_pNative);
        ...
        private static extern bool Windows_Kinect_ColorFrameSource_get_IsActive(
            RootSystem.IntPtr pNative
        );
        ...
        public Windows.Kinect.KinectSensor KinectSensor
        {
            get
            {
                ...
                RootSystem.IntPtr objectPointer = Windows_Kinect_ColorFrameSource_get_KinectSensor(
                    _pNative
                );
                Helper.ExceptionHelper.CheckLastError();
                if (objectPointer == RootSystem.IntPtr.Zero)
        ...
        private static extern void Windows_Kinect_ColorFrameSource_add_FrameCaptured(
            RootSystem.IntPtr pNative,
        ...
        public event RootSystem.EventHandler<Windows.Kinect.FrameCapturedEventArgs> FrameCaptured
        {
            ...
            remove
            {
                ...
                lock (callbackList)
                {
                    ...
                    {
                        Windows_Kinect_ColorFrameSource_add_FrameCaptured(
                            _pNative,
                            Windows_Kinect_FrameCapturedEventArgs_Delegate_Handler,
                            true
                        );
        ...
        private static extern void Windows_Kinect_ColorFrameSource_add_PropertyChanged(
            RootSystem.IntPtr pNative,
        ...
        public event RootSystem.EventHandler<Windows.Data.PropertyChangedEventArgs> PropertyChanged
        {
            ...
            remove
            {
                ...
                lock (callbackList)
                {
                    ...
                    if (callbackList.Count == 0)
                    {
                        Windows_Kinect_ColorFrameSource_add_PropertyChanged(
                            _pNative,
                            Windows_Data_PropertyChangedEventArgs_Delegate_Handler,
                            true
                        );
        ...
        private static extern RootSystem.IntPtr Windows_Kinect_ColorFrameSource_OpenReader(
            RootSystem.IntPtr pNative
        );
        ...
        public Windows.Kinect.ColorFrameReader OpenReader()
        {
            ...
            return Helper.NativeObjectCache.CreateOrGetObject<Windows.Kinect.ColorFrameReader>(
                objectPointer,
                n => new Windows.Kinect.ColorFrameReader(n)
            );
        }
        ...
        )
        {
            ...
            RootSystem.IntPtr objectPointer =
                Windows_Kinect_ColorFrameSource_CreateFrameDescription(_pNative, format);
            Helper.ExceptionHelper.CheckLastError();
            if (objectPointer == RootSystem.IntPtr.Zero)
            {
                return null;
