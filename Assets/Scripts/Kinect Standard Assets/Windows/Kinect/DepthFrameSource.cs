...
namespace Windows.Kinect
{
    ...
    public sealed partial class DepthFrameSource : Helper.INativeWrapper
    {
        ...
        private static extern void Windows_Kinect_DepthFrameSource_ReleaseObject(
        ...
        private static extern void Windows_Kinect_DepthFrameSource_AddRefObject(
            ref RootSystem.IntPtr pNative
        );
        ...
        public Windows.Kinect.FrameDescription FrameDescription
        {
            get
            {
                ...
                RootSystem.IntPtr objectPointer =
                    Windows_Kinect_DepthFrameSource_get_FrameDescription(_pNative);
        ...
        private static extern bool Windows_Kinect_DepthFrameSource_get_IsActive(
            RootSystem.IntPtr pNative
        );
        ...
        public Windows.Kinect.KinectSensor KinectSensor
        {
            get
            {
                ...
                RootSystem.IntPtr objectPointer = Windows_Kinect_DepthFrameSource_get_KinectSensor(
                    _pNative
                );
                Helper.ExceptionHelper.CheckLastError();
                if (objectPointer == RootSystem.IntPtr.Zero)
        ...
        private static extern void Windows_Kinect_DepthFrameSource_add_FrameCaptured(
            RootSystem.IntPtr pNative,
        ...
        public event RootSystem.EventHandler<Windows.Kinect.FrameCapturedEventArgs> FrameCaptured
        {
            ...
            remove
            {
                ...
                lock (callbackList)
                {
                    ...
                    {
                        Windows_Kinect_DepthFrameSource_add_FrameCaptured(
                            _pNative,
                            Windows_Kinect_FrameCapturedEventArgs_Delegate_Handler,
                            true
                        );
        ...
        private static extern void Windows_Kinect_DepthFrameSource_add_PropertyChanged(
            RootSystem.IntPtr pNative,
        ...
        public event RootSystem.EventHandler<Windows.Data.PropertyChangedEventArgs> PropertyChanged
        {
            ...
            remove
            {
                ...
                lock (callbackList)
                {
                    ...
                    if (callbackList.Count == 0)
                    {
                        Windows_Kinect_DepthFrameSource_add_PropertyChanged(
                            _pNative,
                            Windows_Data_PropertyChangedEventArgs_Delegate_Handler,
                            true
                        );
        ...
        private static extern RootSystem.IntPtr Windows_Kinect_DepthFrameSource_OpenReader(
            RootSystem.IntPtr pNative
        );
        ...
        public Windows.Kinect.DepthFrameReader OpenReader()
        {
            ...
            return Helper.NativeObjectCache.CreateOrGetObject<Windows.Kinect.DepthFrameReader>(
                objectPointer,
                n => new Windows.Kinect.DepthFrameReader(n)
            );
        }
