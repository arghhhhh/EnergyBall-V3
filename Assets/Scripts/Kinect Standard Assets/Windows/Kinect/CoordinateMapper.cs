...
namespace Windows.Kinect
{
    ...
    public sealed partial class CoordinateMapper : Helper.INativeWrapper
    {
        ...
        private static extern void Windows_Kinect_CoordinateMapper_ReleaseObject(
        ...
        private static extern void Windows_Kinect_CoordinateMapper_AddRefObject(
            ref RootSystem.IntPtr pNative
        );
        ...
        private delegate void _Windows_Kinect_CoordinateMappingChangedEventArgs_Delegate(
            RootSystem.IntPtr args,
            RootSystem.IntPtr pNative
        );
        private static Helper.CollectionMap<
            RootSystem.IntPtr,
            List<RootSystem.EventHandler<Windows.Kinect.CoordinateMappingChangedEventArgs>>
        > Windows_Kinect_CoordinateMappingChangedEventArgs_Delegate_callbacks =
            new Helper.CollectionMap<
                RootSystem.IntPtr,
                List<RootSystem.EventHandler<Windows.Kinect.CoordinateMappingChangedEventArgs>>
            >();
        ...
        {
            List<RootSystem.EventHandler<Windows.Kinect.CoordinateMappingChangedEventArgs>> callbackList =
                null;
            Windows_Kinect_CoordinateMappingChangedEventArgs_Delegate_callbacks.TryGetValue(
                pNative,
                out callbackList
            );
            lock (callbackList)
        ...
        private static extern void Windows_Kinect_CoordinateMapper_add_CoordinateMappingChanged(
            RootSystem.IntPtr pNative,
            _Windows_Kinect_CoordinateMappingChangedEventArgs_Delegate eventCallback,
            bool unsubscribe
        );
        ...
        public event RootSystem.EventHandler<Windows.Kinect.CoordinateMappingChangedEventArgs> CoordinateMappingChanged
        {
            add
            {
                ...
                Windows_Kinect_CoordinateMappingChangedEventArgs_Delegate_callbacks.TryAddDefault(
                    _pNative
                );
                var callbackList =
                    Windows_Kinect_CoordinateMappingChangedEventArgs_Delegate_callbacks[_pNative];
                lock (callbackList)
                {
                    ...
                    if (callbackList.Count == 1)
                    {
                        ...
                        Windows_Kinect_CoordinateMapper_add_CoordinateMappingChanged(
                            _pNative,
                            del,
                            false
                        );
        ...
        private static extern RootSystem.IntPtr Windows_Kinect_CoordinateMapper_MapCameraPointToDepthSpace(
            RootSystem.IntPtr pNative,
            Windows.Kinect.CameraSpacePoint cameraPoint
        );

        public Windows.Kinect.DepthSpacePoint MapCameraPointToDepthSpace(
            Windows.Kinect.CameraSpacePoint cameraPoint
        )
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            ...
            var objectPointer = Windows_Kinect_CoordinateMapper_MapCameraPointToDepthSpace(
                _pNative,
                cameraPoint
            );
            Helper.ExceptionHelper.CheckLastError();
            var obj = (Windows.Kinect.DepthSpacePoint)
                RootSystem.Runtime.InteropServices.Marshal.PtrToStructure(
                    objectPointer,
                    typeof(Windows.Kinect.DepthSpacePoint)
                );
        ...
        public Windows.Kinect.ColorSpacePoint MapCameraPointToColorSpace(
            Windows.Kinect.CameraSpacePoint cameraPoint
        )
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            ...
            var objectPointer = Windows_Kinect_CoordinateMapper_MapCameraPointToColorSpace(
                _pNative,
                cameraPoint
            );
            Helper.ExceptionHelper.CheckLastError();
            var obj = (Windows.Kinect.ColorSpacePoint)
                RootSystem.Runtime.InteropServices.Marshal.PtrToStructure(
                    objectPointer,
                    typeof(Windows.Kinect.ColorSpacePoint)
                );
            RootSystem.Runtime.InteropServices.Marshal.FreeHGlobal(objectPointer);
            return obj;
        }
        ...
        private static extern RootSystem.IntPtr Windows_Kinect_CoordinateMapper_MapDepthPointToCameraSpace(
            RootSystem.IntPtr pNative,
            Windows.Kinect.DepthSpacePoint depthPoint,
            ushort depth
        );

        public Windows.Kinect.CameraSpacePoint MapDepthPointToCameraSpace(
            Windows.Kinect.DepthSpacePoint depthPoint,
            ushort depth
        )
        {
            ...
            var objectPointer = Windows_Kinect_CoordinateMapper_MapDepthPointToCameraSpace(
                _pNative,
                depthPoint,
                depth
            );
            Helper.ExceptionHelper.CheckLastError();
            var obj = (Windows.Kinect.CameraSpacePoint)
                RootSystem.Runtime.InteropServices.Marshal.PtrToStructure(
                    objectPointer,
                    typeof(Windows.Kinect.CameraSpacePoint)
                );
            RootSystem.Runtime.InteropServices.Marshal.FreeHGlobal(objectPointer);
            return obj;
        }
        ...
        public Windows.Kinect.ColorSpacePoint MapDepthPointToColorSpace(
            Windows.Kinect.DepthSpacePoint depthPoint,
            ushort depth
        )
        {
            ...
            var objectPointer = Windows_Kinect_CoordinateMapper_MapDepthPointToColorSpace(
                _pNative,
                depthPoint,
                depth
            );
        ...
        private static extern void Windows_Kinect_CoordinateMapper_MapCameraPointsToDepthSpace(
            RootSystem.IntPtr pNative,
            RootSystem.IntPtr cameraPoints,
            int cameraPointsSize,
            RootSystem.IntPtr depthPoints,
            int depthPointsSize
        );

        public void MapCameraPointsToDepthSpace(
            Windows.Kinect.CameraSpacePoint[] cameraPoints,
            Windows.Kinect.DepthSpacePoint[] depthPoints
        )
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
            ...
            var cameraPointsSmartGCHandle = new Helper.SmartGCHandle(
            ...
            var depthPointsSmartGCHandle = new Helper.SmartGCHandle(
                RootSystem.Runtime.InteropServices.GCHandle.Alloc(
                    depthPoints,
                    RootSystem.Runtime.InteropServices.GCHandleType.Pinned
                )
            ...
            Windows_Kinect_CoordinateMapper_MapCameraPointsToDepthSpace(
                _pNative,
                _cameraPoints,
                cameraPoints.Length,
                _depthPoints,
        ...
        private static extern void Windows_Kinect_CoordinateMapper_MapCameraPointsToColorSpace(
            ...
            RootSystem.IntPtr cameraPoints,
            int cameraPointsSize,
            RootSystem.IntPtr colorPoints,
            int colorPointsSize
        );

        public void MapCameraPointsToColorSpace(
            Windows.Kinect.CameraSpacePoint[] cameraPoints,
            Windows.Kinect.ColorSpacePoint[] colorPoints
        )
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
            ...
            var _cameraPoints = cameraPointsSmartGCHandle.AddrOfPinnedObject();
            var colorPointsSmartGCHandle = new Helper.SmartGCHandle(
                RootSystem.Runtime.InteropServices.GCHandle.Alloc(
                    colorPoints,
                    RootSystem.Runtime.InteropServices.GCHandleType.Pinned
                )
            ...
            Windows_Kinect_CoordinateMapper_MapCameraPointsToColorSpace(
                _pNative,
                _cameraPoints,
                cameraPoints.Length,
                _colorPoints,
        ...
        )
        {
            ...
            var _depthPoints = depthPointsSmartGCHandle.AddrOfPinnedObject();
            var depthsSmartGCHandle = new Helper.SmartGCHandle(
                RootSystem.Runtime.InteropServices.GCHandle.Alloc(
                    depths,
                    RootSystem.Runtime.InteropServices.GCHandleType.Pinned
                )
            ...
            var _cameraPoints = cameraPointsSmartGCHandle.AddrOfPinnedObject();
            Windows_Kinect_CoordinateMapper_MapDepthPointsToCameraSpace(
                _pNative,
                _depthPoints,
                depthPoints.Length,
                _depths,
        ...
        public void MapDepthPointsToColorSpace(
            Windows.Kinect.DepthSpacePoint[] depthPoints,
            ushort[] depths,
            Windows.Kinect.ColorSpacePoint[] colorPoints
        )
        {
            ...
            var _colorPoints = colorPointsSmartGCHandle.AddrOfPinnedObject();
            Windows_Kinect_CoordinateMapper_MapDepthPointsToColorSpace(
                _pNative,
                _depthPoints,
                depthPoints.Length,
                _depths,
        ...
        public void MapDepthFrameToCameraSpace(
            ...
            Windows.Kinect.CameraSpacePoint[] cameraSpacePoints
        )
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
            ...
            var depthFrameDataSmartGCHandle = new Helper.SmartGCHandle(
                RootSystem.Runtime.InteropServices.GCHandle.Alloc(
                    depthFrameData,
                    RootSystem.Runtime.InteropServices.GCHandleType.Pinned
                )
            ...
            var cameraSpacePointsSmartGCHandle = new Helper.SmartGCHandle(
                RootSystem.Runtime.InteropServices.GCHandle.Alloc(
                    cameraSpacePoints,
                    RootSystem.Runtime.InteropServices.GCHandleType.Pinned
                )
        ...
        public void MapDepthFrameToColorSpace(
            ushort[] depthFrameData,
            Windows.Kinect.ColorSpacePoint[] colorSpacePoints
        )
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
            ...
            var _depthFrameData = depthFrameDataSmartGCHandle.AddrOfPinnedObject();
            var colorSpacePointsSmartGCHandle = new Helper.SmartGCHandle(
                RootSystem.Runtime.InteropServices.GCHandle.Alloc(
                    colorSpacePoints,
                    RootSystem.Runtime.InteropServices.GCHandleType.Pinned
                )
        ...
        public void MapColorFrameToDepthSpace(
            ushort[] depthFrameData,
            Windows.Kinect.DepthSpacePoint[] depthSpacePoints
        )
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
            ...
            var _depthFrameData = depthFrameDataSmartGCHandle.AddrOfPinnedObject();
            var depthSpacePointsSmartGCHandle = new Helper.SmartGCHandle(
                RootSystem.Runtime.InteropServices.GCHandle.Alloc(
                    depthSpacePoints,
                    RootSystem.Runtime.InteropServices.GCHandleType.Pinned
                )
