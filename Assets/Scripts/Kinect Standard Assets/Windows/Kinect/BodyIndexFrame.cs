...
namespace Windows.Kinect
{
    ...
    public sealed partial class BodyIndexFrame : RootSystem.IDisposable, Helper.INativeWrapper
    {
        ...
        private static extern void Windows_Kinect_BodyIndexFrame_ReleaseObject(
        ...
        private static extern void Windows_Kinect_BodyIndexFrame_AddRefObject(
            ref RootSystem.IntPtr pNative
        );
        ...
        public Windows.Kinect.BodyIndexFrameSource BodyIndexFrameSource
        {
            get
            {
                ...
                RootSystem.IntPtr objectPointer =
                    Windows_Kinect_BodyIndexFrame_get_BodyIndexFrameSource(_pNative);
        ...
        public Windows.Kinect.FrameDescription FrameDescription
        {
            get
            {
                ...
                RootSystem.IntPtr objectPointer =
                    Windows_Kinect_BodyIndexFrame_get_FrameDescription(_pNative);
                Helper.ExceptionHelper.CheckLastError();
                if (objectPointer == RootSystem.IntPtr.Zero)
                {
                    return null;
        ...
        private static extern long Windows_Kinect_BodyIndexFrame_get_RelativeTime(
            RootSystem.IntPtr pNative
        );
        ...
        public RootSystem.TimeSpan RelativeTime
        {
            get
            {
                ...
                return RootSystem.TimeSpan.FromMilliseconds(
                    Windows_Kinect_BodyIndexFrame_get_RelativeTime(_pNative)
                );
            }
        }
        ...
        private static extern void Windows_Kinect_BodyIndexFrame_CopyFrameDataToArray(
            RootSystem.IntPtr pNative,
        ...
        public void CopyFrameDataToArray(byte[] frameData)
        {
            ...
            Windows_Kinect_BodyIndexFrame_CopyFrameDataToArray(
                _pNative,
                _frameData,
                frameData.Length
            );
