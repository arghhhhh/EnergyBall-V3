...
namespace Windows.Kinect
{
    ...
    public sealed partial class AudioBeamFrameReader : RootSystem.IDisposable, Helper.INativeWrapper
    {
        ...
        private static extern void Windows_Kinect_AudioBeamFrameReader_ReleaseObject(
        ...
        private static extern void Windows_Kinect_AudioBeamFrameReader_AddRefObject(
            ref RootSystem.IntPtr pNative
        );
        ...
        public Windows.Kinect.AudioSource AudioSource
        {
            get
            {
                ...
                RootSystem.IntPtr objectPointer =
                    Windows_Kinect_AudioBeamFrameReader_get_AudioSource(_pNative);
        ...
        private static extern bool Windows_Kinect_AudioBeamFrameReader_get_IsPaused(
            RootSystem.IntPtr pNative
        );
        ...
        private static extern void Windows_Kinect_AudioBeamFrameReader_put_IsPaused(
            RootSystem.IntPtr pNative,
            bool isPaused
        );
        ...
        private static Helper.CollectionMap<
            RootSystem.IntPtr,
            List<RootSystem.EventHandler<Windows.Kinect.AudioBeamFrameArrivedEventArgs>>
        ...
        [AOT.MonoPInvokeCallbackAttribute(
            typeof(_Windows_Kinect_AudioBeamFrameArrivedEventArgs_Delegate)
        )]
        private static void Windows_Kinect_AudioBeamFrameArrivedEventArgs_Delegate_Handler(
            RootSystem.IntPtr result,
            RootSystem.IntPtr pNative
        )
        {
            List<RootSystem.EventHandler<Windows.Kinect.AudioBeamFrameArrivedEventArgs>> callbackList =
                null;
            Windows_Kinect_AudioBeamFrameArrivedEventArgs_Delegate_callbacks.TryGetValue(
                pNative,
                out callbackList
            );
            lock (callbackList)
        ...
        private static extern void Windows_Kinect_AudioBeamFrameReader_add_FrameArrived(
            RootSystem.IntPtr pNative,
            _Windows_Kinect_AudioBeamFrameArrivedEventArgs_Delegate eventCallback,
            bool unsubscribe
        );
        ...
        public event RootSystem.EventHandler<Windows.Kinect.AudioBeamFrameArrivedEventArgs> FrameArrived
        {
            add
            {
                ...
                Windows_Kinect_AudioBeamFrameArrivedEventArgs_Delegate_callbacks.TryAddDefault(
                    _pNative
                );
                var callbackList = Windows_Kinect_AudioBeamFrameArrivedEventArgs_Delegate_callbacks[
                    _pNative
                ];
                lock (callbackList)
                {
            ...
            remove
            {
                ...
                lock (callbackList)
                {
                    ...
                    {
                        Windows_Kinect_AudioBeamFrameReader_add_FrameArrived(
                            _pNative,
                            Windows_Kinect_AudioBeamFrameArrivedEventArgs_Delegate_Handler,
                            true
                        );
        ...
        private static extern void Windows_Kinect_AudioBeamFrameReader_add_PropertyChanged(
            RootSystem.IntPtr pNative,
                ...
                lock (callbackList)
                {
                    ...
                    if (callbackList.Count == 1)
                    {
                        ...
                        _Windows_Data_PropertyChangedEventArgs_Delegate_Handle =
                            RootSystem.Runtime.InteropServices.GCHandle.Alloc(del);
                        Windows_Kinect_AudioBeamFrameReader_add_PropertyChanged(
                            _pNative,
                            del,
                            false
                        );
        ...
        private static extern int Windows_Kinect_AudioBeamFrameReader_AcquireLatestBeamFrames(
            RootSystem.IntPtr pNative,
        ...
        public RootSystem.Collections.Generic.IList<Windows.Kinect.AudioBeamFrame> AcquireLatestBeamFrames()
        {
            ...
            int outCollectionSize =
                Windows_Kinect_AudioBeamFrameReader_AcquireLatestBeamFrames_Length(_pNative);
            ...
            outCollectionSize = Windows_Kinect_AudioBeamFrameReader_AcquireLatestBeamFrames(
                _pNative,
                outCollection,
                outCollectionSize
            );
            ...
            for (int i = 0; i < outCollectionSize; i++)
            {
                ...
                var obj = Helper.NativeObjectCache.CreateOrGetObject<Windows.Kinect.AudioBeamFrame>(
                    outCollection[i],
                    n => new Windows.Kinect.AudioBeamFrame(n)
                );
        ...
        private static extern void Windows_Kinect_AudioBeamFrameReader_Dispose(
            RootSystem.IntPtr pNative
        );
