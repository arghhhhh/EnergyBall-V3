...
namespace Windows.Kinect
{
    ...
    public sealed partial class DepthFrameReader : RootSystem.IDisposable, Helper.INativeWrapper
    {
        ...
        public Windows.Kinect.DepthFrameSource DepthFrameSource
        {
            get
            {
                ...
                RootSystem.IntPtr objectPointer =
                    Windows_Kinect_DepthFrameReader_get_DepthFrameSource(_pNative);
        ...
        private delegate void _Windows_Kinect_DepthFrameArrivedEventArgs_Delegate(
            RootSystem.IntPtr args,
            RootSystem.IntPtr pNative
        );
        private static Helper.CollectionMap<
            RootSystem.IntPtr,
            List<RootSystem.EventHandler<Windows.Kinect.DepthFrameArrivedEventArgs>>
        > Windows_Kinect_DepthFrameArrivedEventArgs_Delegate_callbacks = new Helper.CollectionMap<
            RootSystem.IntPtr,
            List<RootSystem.EventHandler<Windows.Kinect.DepthFrameArrivedEventArgs>>
        >();
        ...
        private static void Windows_Kinect_DepthFrameArrivedEventArgs_Delegate_Handler(
            RootSystem.IntPtr result,
            RootSystem.IntPtr pNative
        )
        {
            List<RootSystem.EventHandler<Windows.Kinect.DepthFrameArrivedEventArgs>> callbackList =
                null;
            Windows_Kinect_DepthFrameArrivedEventArgs_Delegate_callbacks.TryGetValue(
                pNative,
                out callbackList
            );
            lock (callbackList)
        ...
        private static extern void Windows_Kinect_DepthFrameReader_add_FrameArrived(
            RootSystem.IntPtr pNative,
            _Windows_Kinect_DepthFrameArrivedEventArgs_Delegate eventCallback,
            bool unsubscribe
        );
        ...
        public event RootSystem.EventHandler<Windows.Kinect.DepthFrameArrivedEventArgs> FrameArrived
        {
            add
            {
                ...
                Windows_Kinect_DepthFrameArrivedEventArgs_Delegate_callbacks.TryAddDefault(
                    _pNative
                );
                var callbackList = Windows_Kinect_DepthFrameArrivedEventArgs_Delegate_callbacks[
                    _pNative
                ];
                lock (callbackList)
                {
            ...
            remove
            {
                ...
                lock (callbackList)
                {
                    ...
                    {
                        Windows_Kinect_DepthFrameReader_add_FrameArrived(
                            _pNative,
                            Windows_Kinect_DepthFrameArrivedEventArgs_Delegate_Handler,
                            true
                        );
        ...
        private static extern void Windows_Kinect_DepthFrameReader_add_PropertyChanged(
            RootSystem.IntPtr pNative,
        ...
        public Windows.Kinect.DepthFrame AcquireLatestFrame()
        {
            ...
            RootSystem.IntPtr objectPointer = Windows_Kinect_DepthFrameReader_AcquireLatestFrame(
                _pNative
            );
            Helper.ExceptionHelper.CheckLastError();
            if (objectPointer == RootSystem.IntPtr.Zero)
            ...
            return Helper.NativeObjectCache.CreateOrGetObject<Windows.Kinect.DepthFrame>(
                objectPointer,
                n => new Windows.Kinect.DepthFrame(n)
            );
        }
        ...
        private static extern void Windows_Kinect_DepthFrameReader_Dispose(
            RootSystem.IntPtr pNative
        );
