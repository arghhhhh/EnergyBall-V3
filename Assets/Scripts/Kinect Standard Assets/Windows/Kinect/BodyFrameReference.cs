...
namespace Windows.Kinect
{
    ...
    public sealed partial class BodyFrameReference : Helper.INativeWrapper
    {
        ...
        private static extern void Windows_Kinect_BodyFrameReference_ReleaseObject(
        ...
        private static extern void Windows_Kinect_BodyFrameReference_AddRefObject(
            ref RootSystem.IntPtr pNative
        );
        ...
        private static extern long Windows_Kinect_BodyFrameReference_get_RelativeTime(
        ...
        public Windows.Kinect.BodyFrame AcquireFrame()
        {
            ...
            RootSystem.IntPtr objectPointer = Windows_Kinect_BodyFrameReference_AcquireFrame(
                _pNative
            );
