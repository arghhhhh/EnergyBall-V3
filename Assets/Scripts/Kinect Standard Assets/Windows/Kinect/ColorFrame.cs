...
namespace Windows.Kinect
{
    ...
    public sealed partial class ColorFrame : RootSystem.IDisposable, Helper.INativeWrapper
    {
        ...
        private static extern void Windows_Kinect_ColorFrame_ReleaseObject(
        ...
        public Windows.Kinect.ColorCameraSettings ColorCameraSettings
        {
            get
            {
                ...
                RootSystem.IntPtr objectPointer = Windows_Kinect_ColorFrame_get_ColorCameraSettings(
                    _pNative
                );
                ...
                return Helper.NativeObjectCache.CreateOrGetObject<Windows.Kinect.ColorCameraSettings>(
                    objectPointer,
                    n => new Windows.Kinect.ColorCameraSettings(n)
                );
            }
        }
        ...
        public Windows.Kinect.ColorFrameSource ColorFrameSource
        {
            get
            {
                ...
                RootSystem.IntPtr objectPointer = Windows_Kinect_ColorFrame_get_ColorFrameSource(
                    _pNative
                );
                Helper.ExceptionHelper.CheckLastError();
                if (objectPointer == RootSystem.IntPtr.Zero)
        ...
        public Windows.Kinect.FrameDescription FrameDescription
        {
            get
            {
                ...
                RootSystem.IntPtr objectPointer = Windows_Kinect_ColorFrame_get_FrameDescription(
                    _pNative
                );
                Helper.ExceptionHelper.CheckLastError();
                if (objectPointer == RootSystem.IntPtr.Zero)
                ...
                return Helper.NativeObjectCache.CreateOrGetObject<Windows.Kinect.FrameDescription>(
                    objectPointer,
                    n => new Windows.Kinect.FrameDescription(n)
                );
            }
        }
        ...
        private static extern Windows.Kinect.ColorImageFormat Windows_Kinect_ColorFrame_get_RawColorImageFormat(
            RootSystem.IntPtr pNative
        );
        ...
        private static extern long Windows_Kinect_ColorFrame_get_RelativeTime(
            RootSystem.IntPtr pNative
        );
        ...
        public RootSystem.TimeSpan RelativeTime
        {
            get
            {
                ...
                return RootSystem.TimeSpan.FromMilliseconds(
                    Windows_Kinect_ColorFrame_get_RelativeTime(_pNative)
                );
            }
        }
        ...
        public void CopyRawFrameDataToArray(byte[] frameData)
        {
            ...
            var frameDataSmartGCHandle = new Helper.SmartGCHandle(
            ...
            Windows_Kinect_ColorFrame_CopyRawFrameDataToArray(
                _pNative,
                _frameData,
                frameData.Length
            );
        ...
        private static extern void Windows_Kinect_ColorFrame_CopyConvertedFrameDataToArray(
            RootSystem.IntPtr pNative,
            RootSystem.IntPtr frameData,
            int frameDataSize,
        ...
        )
        {
            ...
            var _frameData = frameDataSmartGCHandle.AddrOfPinnedObject();
            Windows_Kinect_ColorFrame_CopyConvertedFrameDataToArray(
                _pNative,
                _frameData,
                frameData.Length,
                colorFormat
        ...
        private static extern RootSystem.IntPtr Windows_Kinect_ColorFrame_CreateFrameDescription(
            RootSystem.IntPtr pNative,
            Windows.Kinect.ColorImageFormat format
        );

        public Windows.Kinect.FrameDescription CreateFrameDescription(
            Windows.Kinect.ColorImageFormat format
        )
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            ...
            RootSystem.IntPtr objectPointer = Windows_Kinect_ColorFrame_CreateFrameDescription(
                _pNative,
                format
            );
            Helper.ExceptionHelper.CheckLastError();
