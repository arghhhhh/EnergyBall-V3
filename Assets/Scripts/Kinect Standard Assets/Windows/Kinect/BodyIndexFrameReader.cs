...
namespace Windows.Kinect
{
    ...
    public sealed partial class BodyIndexFrameReader : RootSystem.IDisposable, Helper.INativeWrapper
    {
        ...
        private static extern void Windows_Kinect_BodyIndexFrameReader_ReleaseObject(
        ...
        private static extern void Windows_Kinect_BodyIndexFrameReader_AddRefObject(
            ref RootSystem.IntPtr pNative
        );
        ...
        private static extern bool Windows_Kinect_BodyIndexFrameReader_get_IsPaused(
            RootSystem.IntPtr pNative
        );
        ...
        private static extern void Windows_Kinect_BodyIndexFrameReader_put_IsPaused(
            RootSystem.IntPtr pNative,
            bool isPaused
        );
        ...
        private static Helper.CollectionMap<
            RootSystem.IntPtr,
            List<RootSystem.EventHandler<Windows.Kinect.BodyIndexFrameArrivedEventArgs>>
        ...
        [AOT.MonoPInvokeCallbackAttribute(
            typeof(_Windows_Kinect_BodyIndexFrameArrivedEventArgs_Delegate)
        )]
        ...
        {
            List<RootSystem.EventHandler<Windows.Kinect.BodyIndexFrameArrivedEventArgs>> callbackList =
                null;
            Windows_Kinect_BodyIndexFrameArrivedEventArgs_Delegate_callbacks.TryGetValue(
                pNative,
                out callbackList
            );
            lock (callbackList)
        ...
        private static extern void Windows_Kinect_BodyIndexFrameReader_add_FrameArrived(
            RootSystem.IntPtr pNative,
            _Windows_Kinect_BodyIndexFrameArrivedEventArgs_Delegate eventCallback,
            bool unsubscribe
        );
        ...
        public event RootSystem.EventHandler<Windows.Kinect.BodyIndexFrameArrivedEventArgs> FrameArrived
        {
            add
            {
                ...
                Windows_Kinect_BodyIndexFrameArrivedEventArgs_Delegate_callbacks.TryAddDefault(
                    _pNative
                );
                var callbackList = Windows_Kinect_BodyIndexFrameArrivedEventArgs_Delegate_callbacks[
                    _pNative
                ];
                lock (callbackList)
                {
            ...
            remove
            {
                ...
                lock (callbackList)
                {
                    ...
                    {
                        Windows_Kinect_BodyIndexFrameReader_add_FrameArrived(
                            _pNative,
                            Windows_Kinect_BodyIndexFrameArrivedEventArgs_Delegate_Handler,
                            true
                        );
        ...
        private static extern void Windows_Kinect_BodyIndexFrameReader_add_PropertyChanged(
            RootSystem.IntPtr pNative,
                ...
                lock (callbackList)
                {
                    ...
                    if (callbackList.Count == 1)
                    {
                        ...
                        _Windows_Data_PropertyChangedEventArgs_Delegate_Handle =
                            RootSystem.Runtime.InteropServices.GCHandle.Alloc(del);
                        Windows_Kinect_BodyIndexFrameReader_add_PropertyChanged(
                            _pNative,
                            del,
                            false
                        );
        ...
        public Windows.Kinect.BodyIndexFrame AcquireLatestFrame()
        {
            ...
            RootSystem.IntPtr objectPointer =
                Windows_Kinect_BodyIndexFrameReader_AcquireLatestFrame(_pNative);
            Helper.ExceptionHelper.CheckLastError();
            if (objectPointer == RootSystem.IntPtr.Zero)
            {
                return null;
            ...
            return Helper.NativeObjectCache.CreateOrGetObject<Windows.Kinect.BodyIndexFrame>(
                objectPointer,
                n => new Windows.Kinect.BodyIndexFrame(n)
            );
        }
        ...
        private static extern void Windows_Kinect_BodyIndexFrameReader_Dispose(
            RootSystem.IntPtr pNative
        );
