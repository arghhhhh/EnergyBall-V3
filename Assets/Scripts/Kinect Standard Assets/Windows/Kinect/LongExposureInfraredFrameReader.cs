...
namespace Windows.Kinect
{
    ...
    //
    public sealed partial class LongExposureInfraredFrameReader
            ...
            Helper.INativeWrapper
    {
        ...
        private static extern RootSystem.IntPtr Windows_Kinect_LongExposureInfraredFrameReader_get_LongExposureInfraredFrameSource(
            RootSystem.IntPtr pNative
        );
        ...
        private delegate void _Windows_Kinect_LongExposureInfraredFrameArrivedEventArgs_Delegate(
            RootSystem.IntPtr args,
            RootSystem.IntPtr pNative
        );
        private static Helper.CollectionMap<
            RootSystem.IntPtr,
            List<RootSystem.EventHandler<Windows.Kinect.LongExposureInfraredFrameArrivedEventArgs>>
        ...
        {
            List<RootSystem.EventHandler<Windows.Kinect.LongExposureInfraredFrameArrivedEventArgs>> callbackList =
                null;
            Windows_Kinect_LongExposureInfraredFrameArrivedEventArgs_Delegate_callbacks.TryGetValue(
                pNative,
                out callbackList
            );
            lock (callbackList)
            {
                var objThis = Helper.NativeObjectCache.GetObject<LongExposureInfraredFrameReader>(
                    pNative
                );
        ...
        private static extern void Windows_Kinect_LongExposureInfraredFrameReader_add_FrameArrived(
            RootSystem.IntPtr pNative,
            _Windows_Kinect_LongExposureInfraredFrameArrivedEventArgs_Delegate eventCallback,
            bool unsubscribe
        );
        ...
        public event RootSystem.EventHandler<Windows.Kinect.LongExposureInfraredFrameArrivedEventArgs> FrameArrived
        {
            add
            {
                ...
                Windows_Kinect_LongExposureInfraredFrameArrivedEventArgs_Delegate_callbacks.TryAddDefault(
                    _pNative
                );
                var callbackList =
                    Windows_Kinect_LongExposureInfraredFrameArrivedEventArgs_Delegate_callbacks[
                ...
                lock (callbackList)
                {
                    ...
                    {
                        var del =
                            new _Windows_Kinect_LongExposureInfraredFrameArrivedEventArgs_Delegate(
                        ...
                        Windows_Kinect_LongExposureInfraredFrameReader_add_FrameArrived(
                            _pNative,
                            del,
                            false
                        );
                ...
                lock (callbackList)
                {
                    ...
                    if (callbackList.Count == 1)
                    {
                        ...
                        _Windows_Data_PropertyChangedEventArgs_Delegate_Handle =
                            RootSystem.Runtime.InteropServices.GCHandle.Alloc(del);
                        Windows_Kinect_LongExposureInfraredFrameReader_add_PropertyChanged(
                            _pNative,
                            del,
                            false
                        );
        ...
        public Windows.Kinect.LongExposureInfraredFrame AcquireLatestFrame()
        {
            ...
            return Helper.NativeObjectCache.CreateOrGetObject<Windows.Kinect.LongExposureInfraredFrame>(
                objectPointer,
                n => new Windows.Kinect.LongExposureInfraredFrame(n)
            );
        }
        ...
        private static extern void Windows_Kinect_LongExposureInfraredFrameReader_Dispose(
            RootSystem.IntPtr pNative
        );
