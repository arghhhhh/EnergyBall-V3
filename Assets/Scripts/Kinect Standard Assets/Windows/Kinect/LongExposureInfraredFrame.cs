...
namespace Windows.Kinect
{
            ...
            Helper.INativeWrapper
    {
        ...
        private static extern void Windows_Kinect_LongExposureInfraredFrame_ReleaseObject(
        ...
        private static extern void Windows_Kinect_LongExposureInfraredFrame_AddRefObject(
            ref RootSystem.IntPtr pNative
        );
        ...
        private static extern RootSystem.IntPtr Windows_Kinect_LongExposureInfraredFrame_get_LongExposureInfraredFrameSource(
            RootSystem.IntPtr pNative
        );
        ...
        public Windows.Kinect.LongExposureInfraredFrameSource LongExposureInfraredFrameSource
        {
            get
            {
                ...
                RootSystem.IntPtr objectPointer =
                    Windows_Kinect_LongExposureInfraredFrame_get_LongExposureInfraredFrameSource(
                        _pNative
                    );
                Helper.ExceptionHelper.CheckLastError();
                if (objectPointer == RootSystem.IntPtr.Zero)
        ...
        private static extern long Windows_Kinect_LongExposureInfraredFrame_get_RelativeTime(
            RootSystem.IntPtr pNative
        );
        ...
        public void CopyFrameDataToArray(ushort[] frameData)
        {
            ...
            Windows_Kinect_LongExposureInfraredFrame_CopyFrameDataToArray(
                _pNative,
                _frameData,
                frameData.Length
            );
        ...
        private static extern void Windows_Kinect_LongExposureInfraredFrame_Dispose(
            RootSystem.IntPtr pNative
        );
