...
namespace Windows.Kinect
{
    ...
    public sealed partial class InfraredFrame : RootSystem.IDisposable, Helper.INativeWrapper
    {
        ...
        private static extern void Windows_Kinect_InfraredFrame_ReleaseObject(
        ...
        private static extern void Windows_Kinect_InfraredFrame_AddRefObject(
            ref RootSystem.IntPtr pNative
        );
        ...
        public Windows.Kinect.FrameDescription FrameDescription
        {
            get
            {
                ...
                RootSystem.IntPtr objectPointer = Windows_Kinect_InfraredFrame_get_FrameDescription(
                    _pNative
                );
        ...
        public Windows.Kinect.InfraredFrameSource InfraredFrameSource
        {
            get
            {
                ...
                RootSystem.IntPtr objectPointer =
                    Windows_Kinect_InfraredFrame_get_InfraredFrameSource(_pNative);
                Helper.ExceptionHelper.CheckLastError();
                if (objectPointer == RootSystem.IntPtr.Zero)
                {
                    return null;
        ...
        private static extern long Windows_Kinect_InfraredFrame_get_RelativeTime(
            RootSystem.IntPtr pNative
        );
        ...
        public RootSystem.TimeSpan RelativeTime
        {
            get
            {
                ...
                return RootSystem.TimeSpan.FromMilliseconds(
                    Windows_Kinect_InfraredFrame_get_RelativeTime(_pNative)
                );
            }
        }
        ...
        private static extern void Windows_Kinect_InfraredFrame_CopyFrameDataToArray(
            RootSystem.IntPtr pNative,
        ...
        public void CopyFrameDataToArray(ushort[] frameData)
        {
            ...
            Windows_Kinect_InfraredFrame_CopyFrameDataToArray(
                _pNative,
                _frameData,
                frameData.Length
            );
