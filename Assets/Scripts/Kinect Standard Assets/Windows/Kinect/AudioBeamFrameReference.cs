...
namespace Windows.Kinect
{
    ...
    public sealed partial class AudioBeamFrameReference : Helper.INativeWrapper
    {
        ...
        private static extern void Windows_Kinect_AudioBeamFrameReference_ReleaseObject(
        ...
        private static extern void Windows_Kinect_AudioBeamFrameReference_AddRefObject(
            ref RootSystem.IntPtr pNative
        );
        ...
        private static extern long Windows_Kinect_AudioBeamFrameReference_get_RelativeTime(
        ...
        private static extern int Windows_Kinect_AudioBeamFrameReference_AcquireBeamFrames(
            RootSystem.IntPtr pNative,
        ...
        public RootSystem.Collections.Generic.IList<Windows.Kinect.AudioBeamFrame> AcquireBeamFrames()
        {
            ...
            int outCollectionSize = Windows_Kinect_AudioBeamFrameReference_AcquireBeamFrames_Length(
                _pNative
            );
            ...
            outCollectionSize = Windows_Kinect_AudioBeamFrameReference_AcquireBeamFrames(
                _pNative,
                outCollection,
                outCollectionSize
            );
