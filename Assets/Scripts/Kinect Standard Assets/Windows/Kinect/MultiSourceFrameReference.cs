...
namespace Windows.Kinect
{
    ...
    public sealed partial class MultiSourceFrameReference : Helper.INativeWrapper
    {
        ...
        private static extern void Windows_Kinect_MultiSourceFrameReference_ReleaseObject(
        ...
        private static extern void Windows_Kinect_MultiSourceFrameReference_AddRefObject(
            ref RootSystem.IntPtr pNative
        );
        ...
        public Windows.Kinect.MultiSourceFrame AcquireFrame()
        {
            ...
            RootSystem.IntPtr objectPointer = Windows_Kinect_MultiSourceFrameReference_AcquireFrame(
                _pNative
            );
