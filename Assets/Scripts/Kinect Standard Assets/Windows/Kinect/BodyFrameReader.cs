...
namespace Windows.Kinect
{
    ...
    public sealed partial class BodyFrameReader : RootSystem.IDisposable, Helper.INativeWrapper
    {
        ...
        private static extern void Windows_Kinect_BodyFrameReader_ReleaseObject(
        ...
        private static extern void Windows_Kinect_BodyFrameReader_AddRefObject(
            ref RootSystem.IntPtr pNative
        );
        ...
        public Windows.Kinect.BodyFrameSource BodyFrameSource
        {
            get
            {
                ...
                RootSystem.IntPtr objectPointer =
                    Windows_Kinect_BodyFrameReader_get_BodyFrameSource(_pNative);
        ...
        private static extern bool Windows_Kinect_BodyFrameReader_get_IsPaused(
            RootSystem.IntPtr pNative
        );
        ...
        private static extern void Windows_Kinect_BodyFrameReader_put_IsPaused(
            RootSystem.IntPtr pNative,
            bool isPaused
        );
        ...
        private delegate void _Windows_Kinect_BodyFrameArrivedEventArgs_Delegate(
            RootSystem.IntPtr args,
            RootSystem.IntPtr pNative
        );
        private static Helper.CollectionMap<
            RootSystem.IntPtr,
            List<RootSystem.EventHandler<Windows.Kinect.BodyFrameArrivedEventArgs>>
        > Windows_Kinect_BodyFrameArrivedEventArgs_Delegate_callbacks = new Helper.CollectionMap<
            RootSystem.IntPtr,
            List<RootSystem.EventHandler<Windows.Kinect.BodyFrameArrivedEventArgs>>
        >();
        ...
        {
            List<RootSystem.EventHandler<Windows.Kinect.BodyFrameArrivedEventArgs>> callbackList =
                null;
            Windows_Kinect_BodyFrameArrivedEventArgs_Delegate_callbacks.TryGetValue(
                pNative,
                out callbackList
            );
            lock (callbackList)
        ...
        private static extern void Windows_Kinect_BodyFrameReader_add_FrameArrived(
            RootSystem.IntPtr pNative,
            _Windows_Kinect_BodyFrameArrivedEventArgs_Delegate eventCallback,
            bool unsubscribe
        );
        ...
        public event RootSystem.EventHandler<Windows.Kinect.BodyFrameArrivedEventArgs> FrameArrived
        {
            add
            {
                ...
                var callbackList = Windows_Kinect_BodyFrameArrivedEventArgs_Delegate_callbacks[
                    _pNative
                ];
                lock (callbackList)
                {
            ...
            remove
            {
                ...
                lock (callbackList)
                {
                    ...
                    {
                        Windows_Kinect_BodyFrameReader_add_FrameArrived(
                            _pNative,
                            Windows_Kinect_BodyFrameArrivedEventArgs_Delegate_Handler,
                            true
                        );
        ...
        private static extern void Windows_Kinect_BodyFrameReader_add_PropertyChanged(
            RootSystem.IntPtr pNative,
        ...
        public event RootSystem.EventHandler<Windows.Data.PropertyChangedEventArgs> PropertyChanged
        {
            ...
            remove
            {
                ...
                lock (callbackList)
                {
                    ...
                    if (callbackList.Count == 0)
                    {
                        Windows_Kinect_BodyFrameReader_add_PropertyChanged(
                            _pNative,
                            Windows_Data_PropertyChangedEventArgs_Delegate_Handler,
                            true
                        );
        ...
        public Windows.Kinect.BodyFrame AcquireLatestFrame()
        {
            ...
            RootSystem.IntPtr objectPointer = Windows_Kinect_BodyFrameReader_AcquireLatestFrame(
                _pNative
            );
            Helper.ExceptionHelper.CheckLastError();
            if (objectPointer == RootSystem.IntPtr.Zero)
            ...
            return Helper.NativeObjectCache.CreateOrGetObject<Windows.Kinect.BodyFrame>(
                objectPointer,
                n => new Windows.Kinect.BodyFrame(n)
            );
        }
        ...
        private static extern void Windows_Kinect_BodyFrameReader_Dispose(
            RootSystem.IntPtr pNative
        );
