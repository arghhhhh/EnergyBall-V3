...
namespace Windows.Kinect
{
    ...
    public sealed partial class LongExposureInfraredFrameSource : Helper.INativeWrapper
    {
        ...
        )
        {
            ...
            lock (callbackList)
            {
                var objThis = Helper.NativeObjectCache.GetObject<LongExposureInfraredFrameSource>(
                    pNative
                );
            ...
            add
            {
                ...
                lock (callbackList)
                {
                    ...
                    if (callbackList.Count == 1)
                    {
                        ...
                        Windows_Kinect_LongExposureInfraredFrameSource_add_FrameCaptured(
                            _pNative,
                            del,
                            false
                        );
                ...
                lock (callbackList)
                {
                    ...
                    if (callbackList.Count == 1)
                    {
                        ...
                        _Windows_Data_PropertyChangedEventArgs_Delegate_Handle =
                            RootSystem.Runtime.InteropServices.GCHandle.Alloc(del);
                        Windows_Kinect_LongExposureInfraredFrameSource_add_PropertyChanged(
                            _pNative,
                            del,
                            false
                        );
        ...
        public Windows.Kinect.LongExposureInfraredFrameReader OpenReader()
        {
            ...
            RootSystem.IntPtr objectPointer =
                Windows_Kinect_LongExposureInfraredFrameSource_OpenReader(_pNative);
            Helper.ExceptionHelper.CheckLastError();
            if (objectPointer == RootSystem.IntPtr.Zero)
            {
                return null;
            ...
            return Helper.NativeObjectCache.CreateOrGetObject<Windows.Kinect.LongExposureInfraredFrameReader>(
                objectPointer,
                n => new Windows.Kinect.LongExposureInfraredFrameReader(n)
            );
        }
