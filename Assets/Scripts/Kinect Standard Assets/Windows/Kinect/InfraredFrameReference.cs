...
namespace Windows.Kinect
{
    ...
    public sealed partial class InfraredFrameReference : Helper.INativeWrapper
    {
        ...
        private static extern void Windows_Kinect_InfraredFrameReference_ReleaseObject(
        ...
        private static extern void Windows_Kinect_InfraredFrameReference_AddRefObject(
            ref RootSystem.IntPtr pNative
        );
        ...
        private static extern long Windows_Kinect_InfraredFrameReference_get_RelativeTime(
        ...
        public Windows.Kinect.InfraredFrame AcquireFrame()
        {
            ...
            RootSystem.IntPtr objectPointer = Windows_Kinect_InfraredFrameReference_AcquireFrame(
                _pNative
            );
