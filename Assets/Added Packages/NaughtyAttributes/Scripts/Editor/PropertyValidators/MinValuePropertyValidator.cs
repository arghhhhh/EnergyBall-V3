...
namespace NaughtyAttributes.Editor
{
    public class MinValuePropertyValidator : PropertyValidatorBase
    {
        ...
        {
            MinValueAttribute minValueAttribute = PropertyUtility.GetAttribute<MinValueAttribute>(
                property
            );
            ...
            {
                property.vector2Value = Vector2.Max(
            ...
            {
                property.vector3Value = Vector3.Max(
            ...
            {
                property.vector4Value = Vector4.Max(
            ...
            {
                property.vector2IntValue = Vector2Int.Max(
            ...
            {
                property.vector3IntValue = Vector3Int.Max(
            ...
            {
                string warning =
                    minValueAttribute.GetType().Name
