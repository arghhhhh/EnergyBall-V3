...
namespace NaughtyAttributes.Editor
{
    public class MaxValuePropertyValidator : PropertyValidatorBase
    {
        ...
        {
            MaxValueAttribute maxValueAttribute = PropertyUtility.GetAttribute<MaxValueAttribute>(
                property
            );
            ...
            {
                property.vector2Value = Vector2.Min(
            ...
            {
                property.vector3Value = Vector3.Min(
            ...
            {
                property.vector4Value = Vector4.Min(
            ...
            {
                property.vector2IntValue = Vector2Int.Min(
            ...
            {
                property.vector3IntValue = Vector3Int.Min(
            ...
            {
                string warning =
                    maxValueAttribute.GetType().Name
